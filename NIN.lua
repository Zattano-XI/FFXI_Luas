...
function user_setup()
    state.OffenseMode:options('Normal', 'Capacity', 'DT', 'LowAcc', 'MidAcc', 'HighAcc', 'STP')
...
function init_gear_sets()
    ...
    sets.precast.WS['Blade: Metsu'] = set_combine(sets.precast.WS, {
		...
		--feet="Mochi. Kyahan +3",
		waist="Sailfi Belt +1",
        back=gear.NIN_WS3_Cape, --WS3 cape
        })
    ...
    sets.precast.WS['Blade: Kamu'] = set_combine(sets.precast.WS, {
		...
		--hands="Mochizuki Tekko +3",
		--legs="Mochi. Hakama +3",
		--feet="Ryuo Sune-Ate +1", augments={'STR+12','DEX+12','Accuracy+20',}},
		--neck="Ninja Nodowa +2",
		waist="Sailfi Belt +1",
		ear2="Mache Earring +1",
		ear1="Lugra Earring +1",
	...
	sets.precast.WS['Savage Blade'] = {
		...
		body="Nyame Mail",
		hands="Nyame Gauntlets",
		legs="Nyame Flanchard",--legs={ name="Mochi. Hakama +3", augments={'Enhances "Mijin Gakure" effect',}},
		feet="Nyame Sollerets",
		--neck={ name="Ninja Nodowa +2", augments={'Path: A',}},
...
--    sets.resting = {}
    ...
    sets.engaged = {
        ammo="Seki Shuriken", --Seki Shuriken
        head="Ryuo Somen +1", --9
...
--    sets.buff.Migawari = {body="Iga Ningi +2"}
    ...
    sets.TreasureHunter = {ammo="Perfect Lucky Egg", head="White Rarab Cap +1", hands=gear.Herc_TH_hands, waist="Chaac Belt"}
